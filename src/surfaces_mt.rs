...
pub type Surf = Arc<dyn Surface + Sync + Send>;
pub type SurfList = Arc<Vec<Surf>>;
...
impl Union {
    pub fn new(surface1: Arc<dyn Surface>, surface2: Arc<dyn Surface>) -> Self {
...
impl SmoothUnion {
    pub fn new(surface1: Arc<dyn Surface>, surface2: Arc<dyn Surface>, blend_factor: f32) -> Self {
        Self {
            surface1,
            surface2,
            k: blend_factor,
